...
- Select a category and recipe.
- Adjust servings if needed.
- Use voice commands or buttons to navigate steps.
- Set timers and enjoy cooking!

## Deployment

This app is ready for deployment on Streamlit Cloud. Upload the code and it should work seamlessly.
=======
# 🎤 Voice-Controlled Cooking Assistant
...
>>>>>>> 8d7c428ca1df93d0f10b8eb4aaacd9e2aa56741f
